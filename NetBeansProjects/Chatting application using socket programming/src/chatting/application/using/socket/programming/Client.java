...
import static chatting.application.using.socket.programming.Server.dout;
import static chatting.application.using.socket.programming.Server.f;
import static chatting.application.using.socket.programming.Server.formatLabel;
import static chatting.application.using.socket.programming.Server.vertical;
import java.util.*;
import java.text.*;
import javax.swing.*;
import java.awt.*;
...
//java swing and awt
public class Client  implements ActionListener {//after running the class we will see the frame. Hence we will do the coding of constructor in the frame only.
    ...
    Client (){
        ...
        JLabel name = new JLabel ("Apoorv Yadav");
